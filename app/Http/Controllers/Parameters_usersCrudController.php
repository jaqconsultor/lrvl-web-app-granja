...
use App\Models\Parameters_users;
use Session;
use DB;

class Parameters_usersCrudController extends Controller
{

    public function index()
    {
        $title='Lista';
        $data=Parameters_users::all();
        return view('crud/crudparameters_users/listar',compact('data','title'));
    }

    public function create()
    {
        $title='Crear Parameters_users';
        return view('crud/crudparameters_users/crear')->with('title',$title);
    }

    public function store(Request $request)
    {
        Parameters_users::create([
        ...
        return redirect('/Cruds/Parameters_users/lista');
    }

    public function show($id)
    {
        $title='Mofificar';
        $data=Parameters_users::where('id','=',$id)->first();
        return view('crud/crudparameters_users/modificar')->with( array('data'=>$data,'title'=>$title));
    }
    ...
    {
        $grabar=Parameters_users::Find($id);
    ...
    {
        Parameters_users::find($id)->delete(['id','=',$id]);
        return redirect('/Cruds/Parameters_users/lista');
    }

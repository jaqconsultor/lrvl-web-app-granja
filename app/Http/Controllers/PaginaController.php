...
class PaginaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('template/blank', $datos , compact('data','title') );
...
//        return view('crud/crudprojects/listar', $datos , compact('data','title') );
    ...
    public function login()
    {
        ...
        return view('registro/login', $datos , compact('data','title') );
    }
    ...
    public function registro()
    {
        ...
        return view('registro/registro', $datos , compact('data','title') );
    }
    ...
    public function olvido()
    {
        ...
        return view('registro/olvido', $datos , compact('data','title') );

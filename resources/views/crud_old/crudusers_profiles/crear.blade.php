...
<label for='id_users'>ID_USERS</label><input type='text' class='form-control' name='id_users' required='required' ><label for='id_profiles'>ID_PROFILES</label><input type='text' class='form-control' name='id_profiles' required='required' ><label for='fe_vencimiento'>FE_VENCIMIENTO</label><input type='text' class='form-control' name='fe_vencimiento' required='required' ><label for='in_activerecord'>IN_ACTIVERECORD</label><input type='text' class='form-control' name='in_activerecord' required='required' >
            <br>

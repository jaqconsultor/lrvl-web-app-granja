...
<form action="{{url('
/Cruds/Datos_notas/GuardarNuevo
')}}" method="post">
...
<label for='fe_registro'>FE_REGISTRO</label><input type='text' class='form-control' name='fe_registro' required='required' ><label for='id_control'>ID_CONTROL</label><input type='text' class='form-control' name='id_control' required='required' ><label for='tx_nota'>TX_NOTA</label><input type='text' class='form-control' name='tx_nota' required='required' ><label for='tx_usu_crea'>TX_USU_CREA</label><input type='text' class='form-control' name='tx_usu_crea' required='required' ><label for='tx_usu_ver'>TX_USU_VER</label><input type='text' class='form-control' name='tx_usu_ver' required='required' ><label for='in_leido'>IN_LEIDO</label><input type='text' class='form-control' name='in_leido' required='required' >
            <br>
